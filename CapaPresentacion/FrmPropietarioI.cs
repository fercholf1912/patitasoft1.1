...
{
    public partial class FrmPropietarioI : Form
    {
        public FrmPropietarioI()
        {
            InitializeComponent();
        }
        ...
        private void FrmPropietarioI_Load(object sender, EventArgs e)
        {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    Rpta = NPersona.Insertar(txtCedula.Text.Trim(), txtNombre.Text.Trim(), txtDireccion.Text.Trim(),txtTelefono.Text,genero);
                    if (Rpta == "OK")
                    {
